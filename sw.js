const CACHE_NAME = "kaoshang-social-worker-v41";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=20260705-41",
  "./app.js?v=20260705-41",
  "./app-core.mjs?v=20260705-15",
  ...
  "./data/index.json?v=20260705-154",
  "./data/law-lookup.json?v=20260705-154"
];
